...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    panel2: 'rgba(168,85,247,0.06)',
    panelHover: 'rgba(168,85,247,0.1)',
  ...
  },
  {
    ...
    emoji: '🌑',
    mode: 'dark',
    // Paleta idéntica a Eclipse; el "menos morado" (más negro, morado solo en
    // esquinas/centro + halo que sigue el cursor) se resuelve en index.css.
    primary: '#a855f7',
    secondary: '#6d28d9',
    bg: '#000000',
    bg2: '#060309',
    ...
    panel2: 'rgba(168,85,247,0.045)',
    panelHover: 'rgba(168,85,247,0.075)',
